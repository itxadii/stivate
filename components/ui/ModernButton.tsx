...
export default function ModernButton({
  ...
  const baseClasses = `inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full border border-zinc-900 bg-transparent text-zinc-900 text-sm font-bold hover:bg-[#C3E236] hover:text-zinc-900 transition-all duration-300 group disabled:opacity-70 disabled:pointer-events-none cursor-pointer ${className}`;
