      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-6">
          {jobs.map((job, i) => (
            <motion.div
              ...
              className="group p-8 rounded-3xl bg-zinc-50 border border-zinc-100 hover:border-zinc-200 hover:bg-white hover:shadow-xl transition-all duration-300 flex flex-col md:flex-row md:items-center justify-between gap-6"
            >
              ...
              <button className="flex-shrink-0 w-14 h-14 rounded-full bg-zinc-900 text-white flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <ArrowRight size={24} />
              </button>
            </motion.div>
          ))}
        ...
        <div className="mt-20 p-10 rounded-[40px] bg-[#FFF6DE] text-center border border-[#e4d9b8]">
          ...
          <p className="text-zinc-600 mb-8 max-w-xl mx-auto">
            ...
            <span className="font-bold text-zinc-900 ml-1">careers@stivate.com</span>
          </p>
          <a 
            href="mailto:careers@stivate.com" 
