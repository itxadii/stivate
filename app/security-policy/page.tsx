        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4 text-zinc-600 leading-relaxed">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><span className="font-bold text-zinc-900">Role-Based Access Control (RBAC):</span> Access to business tools (clients, invoices, pricing estimations) is regulated by roles: <code className="bg-zinc-100 px-1 py-0.5 rounded text-xs font-mono text-zinc-800">SUPERADMIN</code>, <code className="bg-zinc-100 px-1 py-0.5 rounded text-xs font-mono text-zinc-800">ADMIN</code>, <code className="bg-zinc-100 px-1 py-0.5 rounded text-xs font-mono text-zinc-800">MANAGER</code>, and <code className="bg-zinc-100 px-1 py-0.5 rounded text-xs font-mono text-zinc-800">STAFF</code>.</li>
