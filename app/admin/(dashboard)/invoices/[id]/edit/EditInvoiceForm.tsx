...
import { updateInvoice, archiveInvoice } from "@/lib/actions/invoice"
import { Plus, Trash2, Calendar, Receipt, Info, Trash, Sparkles, Copy, CheckCircle } from "lucide-react"
...
export default function EditInvoiceForm({ invoice, projects }: EditInvoiceFormProps) {
  ...
  const [discountRate, setDiscountRate] = useState(invoice.discountRate || 0)
    ...
    <>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full rounded-md border-0 py-2 pl-10 pr-3 text-gray-955 ring-1 ring-inset ring-gray-350 focus:ring-2 focus:ring-blue-600 sm:text-sm dark:bg-gray-800 dark:text-white dark:ring-gray-700"
              required
            />
          </div>
        </div>
                ...
                <tr key={idx} className="align-middle">
                  ...
                  <td className="px-3 py-3">
                    <input
                      ...
                      className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-blue-600 sm:text-sm dark:bg-gray-855 dark:text-white dark:ring-gray-700"
                      required
                    />
                  </td>
                  <td className="px-3 py-3">
      ...
      <div className="flex items-center justify-between gap-3 border-t border-gray-200 dark:border-gray-800 pt-6">
        <button
          ...
          className="rounded-md bg-white dark:bg-gray-800 px-4 py-2 text-sm font-semibold text-red-600 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-red-50 dark:hover:bg-red-900/20"
        >
          <Trash className="inline w-4 h-4 mr-1.5" />
          Archive Invoice
        </button>
